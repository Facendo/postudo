...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(135deg, #cef5e3ff 0%, #4be4e9ff 100%);
        ...
        .page-content {
            padding-top: 0;
            /* No padding at the top if nav is fixed */
        }
        ...
        .cta-section {
            padding: 100px 40px;
            /* Generous padding for all major sections */
            max-width: 1400px;
        ...
        .button_barra {
            margin: 0 20px;
            padding: 12px 22px;
            /* Reducido ligeramente para más cohesión */
            text-decoration: none;
            color: #a7d9ef;
            /* Color base más suave */
            font-family: 'Montserrat', sans-serif;
            font-size: 16px;
            /* Ajuste de tamaño */
            border-radius: 8px;
            /* Menos redondeado para un look más moderno */
            ...
            display: inline-flex;
            /* Para centrar el texto verticalmente si es necesario */
            align-items: center;
        ...
        @keyframes shine {
            ...
            50% {
                box-shadow: 0 0 25px rgba(239, 35, 60, 0.7);
                /* Brillo rojo */
            }
        ...
        .hero-section {
            ...
            background: linear-gradient(135deg, #e4e4e4ff 0%, #17d1b8ff 100%);
            display: flex;
            align-items: center;
            justify-content: center;
            text-align: center;
        ...
        .btn {
            ...
            padding: 16px 38px;
            /* Mayor padding para un look más premium */
            border-radius: 50px;
        ...
        .btn-primary:hover {
            background: linear-gradient(45deg, #fc4700, #e67e55);
            /* Invertir degradado al hover */
            transform: translateY(-7px);
            /* Lift más pronunciado */
            box-shadow: 0 10px 20px rgba(0, 0, 0, 0.3);
            /* Sombra más fuerte */
            animation: none;
            /* Deshabilitar animación de pulso si hay otra */
        }
        ...
        .about-us-section {
            ...
            justify-content: space-between;
            gap: 80px;
            /* More space for a clean layout */
            text-align: left;
            background: linear-gradient(135deg, #bdd0f0 0%, #1d3070 100%);
            border-radius: 15px;
            /* Subtle rounded corners for the section */
        ...
        .about-image {
            ...
            object-fit: cover;
            filter: grayscale(10%);
            /* Efecto sutil para que la imagen se integre mejor */
            transition: filter 0.3s ease-in-out;
        }

        .about-image:hover {
            filter: grayscale(0%);
            /* Color completo al pasar el ratón */
        }
        ...
        .program-card {
            ...
            /* Sombra más suave inicialmente */
            transition: transform 0.4s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.4s cubic-bezier(0.25, 0.8, 0.25, 1);
            text-align: center;
            border: 1px solid rgba(0, 0, 0, 0.08);
            /* Borde sutil */
            display: flex;
            /* Flexbox para contenido interno */
            flex-direction: column;
            justify-content: space-between;
            /* Para empujar el link al final */
        }
        ...
        .program-card p {
            ...
            margin-bottom: 25px;
            flex-grow: 1;
            /* Permite que el párrafo crezca y ocupe espacio */
        }

        .card-link {
            display: inline-block;
            margin-top: auto;
            /* Empuja el link hacia abajo */
            color: #007bff;
            text-decoration: none;
            font-weight: 700;
            position: relative;
            padding-bottom: 5px;
            font-size: 1.1em;
            /* Link de tarjeta ligeramente más grande */
        }
        ...
        .cta-section {
            ...
            text-align: center;
            border-radius: 20px;
            /* Más redondeado para la sección */
            margin: 80px auto;
            /* Más margen, centrado */
        ...
        @media (max-width: 480px) {
            ...
            .button_barra {
                display: none;
                /* Hide nav links on very small screens, consider a hamburger menu */
            }
        ...
        <div class="page-content">
            <div class="hero-section">
                <div class="hero-content">
                    ...
                    <p>Tu plataforma integral para acceder a posgrados de vanguardia y especialización que transformarán
                        tu carrera.</p>
            ...
            <div id="about-us" class="about-us-section">
                <div class="about-text-content">
                    ...
                    <p>
                        En PostUDO, estamos comprometidos con tu crecimiento profesional y académico. Hemos diseñado
                        esta plataforma pensando en ti: el profesional ambicioso que busca trascender, el investigador
                        apasionado en pos de nuevos horizontes, o el recién graduado listo para dar el siguiente gran
                        paso en su carrera.
                    </p>
                    <p>
                        Creemos que la especialización y la formación continua son pilares fundamentales para el éxito
                        en un entorno profesional en constante evolución. Por eso, te ofrecemos acceso a programas de
                        posgrado de alta calidad que te equiparán con las herramientas y el conocimiento para liderar en
                        tu campo.
                    </p>
                </div>
                <div class="about-image-container">
                    <img src="{{ asset('Profesionales_investigando.jpg') }}" alt="Profesionales investigando"
                        class="about-image">
                </div>
            </div>
            ...
            <div id="offerings" class="offerings-section">
                ...
                <p class="section-description">Descubre programas de posgrado diseñados para las demandas del mercado
                    actual y futuro.</p>
                <div class="program-cards-container">
                    <div class="program-card">
                        <h3>Maestrías</h3>
                        <p>Consolida tus conocimientos y adquiere habilidades avanzadas en diversas áreas. Perfectas
                            para la especialización.</p>
                        <a href="{{ url('/postgrado') }}" class="card-link">Ver Maestrías &rarr;</a>
                    </div>
                    <div class="program-card">
                        <h3>Doctorados</h3>
                        <p>Impulsa la frontera del saber y conviértete en un investigador líder. Ideal para la
                            innovación y la academia.</p>
                        <a href="{{ url('/postgrado') }}" class="card-link">Ver Doctorados &rarr;</a>
                    </div>
                    <div class="program-card">
                        <h3>Diplomados y Especializaciones</h3>
                        <p>Formación intensiva y específica para potenciar habilidades clave en corto tiempo.
                            Actualízate rápidamente.</p>
