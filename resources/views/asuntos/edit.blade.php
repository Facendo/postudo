            ...
            <form action="{{ route('asuntos.update', $asunto->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" class="form-input"
                        placeholder="Ej: Inscripción de Materias" value="{{ old('nombre', $asunto->nombre) }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-input"
                        ...
                        rows="3">{{ old('descripcion', $asunto->descripcion) }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="valor-usd-wrapper">
                        ...
                        <input type="number" id="valor_usd" name="valor_usd" class="form-input valor-usd-input"
                            ...
                            value="{{ old('valor_usd', $asunto->valor_usd ?? 0) }}">
                    </div>
